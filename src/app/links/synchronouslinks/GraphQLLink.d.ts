...
import { MergedConfiguration, QueryResult } from "../../controllers/GraphController";
...
export interface MutateResult extends CreateCategory, CreateCoupon, UpdateAllMenuItemsStatusForVendor, UpdateCustomer, UpdateNoteForCart, RemoveCouponFromCart, ApplyCouponToCart, VerifySmsVerificationSession, CreateSmsVerificationSession, UpdateVendor, CreateVendorWithEmployee, RequestVendorApproval, UpdateVendorApprovalStatus, AddVendorTesterByEmailAddress, DeleteVendorTester, CreateTip, CreateSurveyResponse, DeleteSurvey, ArchiveSurvey, ReleaseSurvey, UpdateSurvey, CreateSurvey, DeleteRawConfiguration, UpdateRawConfiguration, CreateRawConfiguration, Merged_Configuration, DeleteRedeemableItem, updateRedeemableItem, CreateRedeemableItem, CancelPayout, UpdatePayout, RequestPayout, CompleteOrder, PreparedOrder, BeginPreparingOrder, CancelOrder, CreateOrder, DeleteModifier, UpdateModifier, CreateModifier, BatchUpdateMenuItems, DeleteMenuItem, UpdateMenuItem, CreateMenuItem, DeleteLoyaltyProgram, UpdateLoyaltyProgram, CreateLoyaltyProgram, RedeemLoyaltyPointsForCoupon, ShareLoyaltyPoints, AwardShareablePointsToLoyaltyCard, AwardPointsToLoyaltyCard, CreateLoyaltyCardAndEnroll, DeleteHeadOffice, UpdateHeadOffice, CreateHeadOffice, UpdateFlashSale, CreateFlashSale, ReplaceExplorePage, CreateEmployeeToken, ResetEmployeePassword, SendEmployeePasswordResetCode, RevokeEmployeeTerminalFcmToken, EnrollEmployeeTerminalFcmToken, DeleteEmployee, UpdateEmployee, CreateEmployee, CreateCustomerToken, RemoveFavouriteItemForCustomer, AddFavouriteItemForCustomer, RemoveFavouriteVendorForCustomer, AddFavouriteVendorForCustomer, CreateCustomerWalletTransaction, RefundCustomerWallet, ReloadCustomerWallet, CreateCustomerWallet, UpdateCustomerCreditCard, RevokeCustomerFcmToken, EnrollCustomerFcmToken, RevokeCustomerApnsToken, EnrollCustomerApnsToken, ResetCustomerPassword, SendCustomerPasswordResetCode, UpdateCustomer, CreateCustomer, DeleteCategory, CreateCart, AddItemCart, RemoveItemFromCart, CreateCoupon, CreateCategory, DeleteCart, ApplyCouponToCart, RemoveCouponFromCart, UpdateNoteForCart, UpdateCategory, BatchUpdateCategories {
}
