import { PaymentMethodsInput, PaymentMethods, Coupon } from "./CouponController";
import { App } from "../App";
...
export declare enum PayoutAutoRequestSchedule {
    OFF = "OFF",
    WEEKLY = "WEEKLY",
    BI_WEEKLY = "BI_WEEKLY",
    MONTHLY = "MONTHLY"
...
export declare enum VendorAnalyticsCustomerType {
...
export declare class VendorController {
     ...
     */
    addVendorTesterByEmailAddress(id: string, email_address: string): Promise<VendorTester>;
    /**
     ...
     * @returns {Promise<string>}
     */
    updateVendorApprovalStatus(id: string, approval_status: VendorApprovalStatus): Promise<string>;
    /**
